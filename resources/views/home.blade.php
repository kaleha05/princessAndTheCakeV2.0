...
@section('content')
				...
				<li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
					...
					<div class="slider_text_box">
						<div class="tp-caption tp-resizeme first_text" data-x="['left','left','left','15','15']"
							...
							data-textAlign="['left','left','left','left']">Princess & the Cake <br> Home of luxury celebration cakes</div>
						...
						<div class="tp-caption tp-resizeme slider_button" 
                                ...
                                <a class="main_btn" href="#cakes">Welcome</a>
                        </div>
                    </div>
				</li>
		...
		<div id="main_slider" class="rev_slider" data-version="5.3.1.6">
			<ul>
				<li data-index="rs-1587" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
					...
					data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<!-- <img src="{{asset('assets/img/cakesicle3.jpg')}}" alt="" data-bgposition="center center" data-bgfit="cover"
						data-bgrepeat="no-repeat" data-bgparallax="5" class="rev-slidebg" data-no-retina> -->
	...
	<!--================Welcome Area =================-->
	<section class="welcome_bakery_area" id="cakes">
		<div class="container">
	...
	<section class="client_says_area p_100">
		<div class="container">
			<div class="client_says_inner">
				...
				<br>
				<a class="pink_more" href="{{url('reviews')}}">Write your review</a>
			</div>
		</div>
	</section>
