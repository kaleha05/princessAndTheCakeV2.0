				...
				<div class="row footer_wd_inner">
					...
					<div class="col-lg-3 col-6">
						<aside class="f_widget f_contact_widget">
							...
							<h4>+254 705303081</h4>
							<p>360 degrees apartments <br />Syokimau</p>
							<h5>cakes@princessandthecake.co.ke</h5>
						</aside>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="copyright_inner">
					<div class="float-left">
						<h5><a target="_blank" href="https://gloria-keya.herokuapp.com" style="color: white">Designed by Gloria Keya</a></h5>
					</div>
				</div>
			</div>
		</div>
